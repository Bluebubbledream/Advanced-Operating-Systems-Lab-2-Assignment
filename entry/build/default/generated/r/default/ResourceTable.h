...
const int32_t STRING_PERM_REASON = 0x0100000e;
const int32_t STRING_PERMISSION_GET_BUNDLE_INFO = 0x0100000c;
const int32_t STRING_PERMISSION_START_ABILITY = 0x0100000d;
